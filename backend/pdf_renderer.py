...
Uses reportlab to produce a single-page printable dossier.
"""
...
def build_report_pdf(doc_record: dict) -> bytes:
    """
    Render a trademark report (the dict stored in Mongo) to a PDF and return bytes.
    """
    ...
    story.append(Paragraph(f"Trademark Availability Dossier", st["h1"]))
