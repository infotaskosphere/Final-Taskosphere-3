...
app.add_middleware(
    ...
    allow_methods=["*"], # This allows GET, POST, PUT, DELETE, OPTIONS, etc.
    allow_headers=["*"], # This allows Authorization and Content-Type headers
)
...
async def get_upcoming_due_dates(
    ...
    for dd in due_dates:
        ...
        days_remaining = (dd["due_date"] - now).days
