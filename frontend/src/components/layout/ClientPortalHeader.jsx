      ...
      >
        ...
        <div className="relative px-6 py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4 min-w-0 w-full sm:w-auto">
            ...
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-white/15 flex items-center justify-center flex-shrink-0 shadow-sm">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h1 className="text-lg sm:text-xl font-bold text-white leading-snug tracking-tight truncate">
                {title || 'Client Portal Manager'}
              </h1>
              {subtitle && (
                <p className="text-white/55 text-xs sm:text-sm mt-0.5 truncate">{subtitle}</p>
              )}
            </div>
          </div>

          {/* Right: actions + live portal link */}
          <div className="flex items-center gap-2.5 flex-shrink-0 w-full sm:w-auto justify-end sm:justify-start">
            {actions}
            <motion.a
              href="/client-portal"
              target="_blank"
