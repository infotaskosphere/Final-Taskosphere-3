...
export default function Users() {
  ...
  // ── Parallel fast data loading (big speed improvement) ───────────────────────
  useEffect(() => {
                      ...
                      return (
                        <button
                          ...
                          className={`h-12 rounded-2xl text-sm font-semibold border-2 transition-all ${
                            active ? 'text-white border-transparent shadow' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300'
                          }`}
                          ...
                          >
                            <div
                              className={`w-10 h-10 rounded-2xl flex items-center justify-center flex-shrink-0 ${
                                isAssigned ? 'bg-emerald-500 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'
                              }`}
                            >
