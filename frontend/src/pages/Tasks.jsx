...
export default function Tasks() {
  ...
  return (
    ...
    >
      ...
      {/* ── ROW 1: BIG METRIC CARDS — overall scope stats, click to filter ── */}
      <motion.div
      ...
      {/* ── ROW 2: SMALL FILTERED STAT CARDS — reacts to displayTasks in real-time ── */}
      <motion.div
        variants={itemVariants}
      ...
      >
        {[
          {
            label: activeFilters.length > 0 ? 'Filtered: Assigned' : 'Showing: All Mine',
          ...
          <motion.div
            ...
            className={`rounded-xl border px-3 py-2.5 flex items-center gap-3 shadow-sm
              ${isDark
                ...
                : 'bg-slate-100/70 border-slate-300/60'
              }`}
          >
            <div
            ...
            <div className="min-w-0 flex-1">
              ...
              {card.progress !== undefined && (
                <div className={`mt-1 h-1 rounded-full overflow-hidden ${isDark ? 'bg-slate-700' : 'bg-slate-300'}`}>
                  <motion.div
                    className="h-full rounded-full"
