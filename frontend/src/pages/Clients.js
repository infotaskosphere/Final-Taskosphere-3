...
/* ===========================================================
   CONFIRM IMPORT (FOR CSV + EXCEL PREVIEW)
=========================================================== */
    ...
    <div style={style} className="p-3">
      <Card
        ...
        className="h-full rounded-2xl border border-slate-200 bg-white 
                   ...
                   duration-300 group cursor-pointer relative"
      >
        ...
        <div className="p-4 flex flex-col h-full">
          ...
          <div
            className="mt-4 border-t pt-3 flex justify-end gap-1 
