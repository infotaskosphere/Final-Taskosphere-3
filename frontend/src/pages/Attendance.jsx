  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        {/* ──────────────────────────────────────────────────────────────── */}
        {/* STRUCTURED 3-COLUMN DASHBOARD LAYOUT (replaces vertical attOrder.map) */}
        {/* ──────────────────────────────────────────────────────────────── */}
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
          {/* LEFT COLUMN (4/12) — Today Status + Stats + Admin Summaries */}
          <div className="xl:col-span-4 space-y-6">
            {/* today_status section content */}
            {attOrder.includes('today_status') && (
              <React.Fragment>
                {!isEveryoneView && (
                  <motion.div variants={itemVariants}>
                    <SectionCard>
            ...
            {/* stat_cards section content */}
            {attOrder.includes('stat_cards') && (
              <motion.div
          ...
          {/* CENTER COLUMN (5/12) — Calendar Area + all modals */}
          <div className="xl:col-span-5 space-y-6">
            {attOrder.includes('calendar_area') && (
              <React.Fragment>
                <motion.div
                  className={`grid gap-6 ${isEveryoneView ? 'grid-cols-1' : 'grid-cols-1 xl:grid-cols-2'}`}
                  variants={itemVariants}
                >
                  {/* ── LEFT SUB-COLUMN: Calendar + Date Detail + Apply Leave ── */}
                  {!isEveryoneView && (
                  ...
                  {/* ── RIGHT SUB-COLUMN: Location History + Recent Attendance ── */}
                  <div className="flex flex-col gap-4">
                    {/* Location History */}
                    {(() => {
                ...
                {/* ══ MODALS (moved here from original calendar_area block) ════════════════════════════════════════════════════════════ */}
                {/* Punch-In Modal */}
                <AnimatePresence>
          ...
          {/* RIGHT COLUMN (3/12) — Holidays & Monthly Insights */}
          <div className="xl:col-span-3 space-y-6">
            {attOrder.includes('holidays_reminders') && (
