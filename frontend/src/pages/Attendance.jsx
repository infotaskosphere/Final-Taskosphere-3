    ...
    <TooltipProvider>
      ...
      >
        ...
        >
          ...
          <div className={isEveryoneView ? '' : 'xl:col-span-2 flex flex-col'}>
            <SectionCard className="flex-1 flex flex-col">
              ...
              <div className="p-4 flex-1 flex flex-col">
                {loading && attendanceHistory.length === 0 ? (
                  ...
                  <p className="text-center py-12 text-sm font-medium text-slate-400">No records yet</p>
                ) : (
                  <div className="space-y-2 max-h-[700px] overflow-y-auto slim-scroll" style={slimScroll}>
                            ...
                            <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
                              {isAbsent ? (
                                ...
                                <span className="text-[10px] font-bold uppercase px-2 py-1 rounded"
                                  style={{ color: COLORS.orange, backgroundColor: isDark ? 'rgba(249,115,22,0.15)' : `${COLORS.orange}18` }}>
                                  Leave
                                </span>
                              ) : (
