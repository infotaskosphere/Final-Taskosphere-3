...
export default function Reports() {
  ...
  /* 
  === DUPLICATE BLOCK START (kept 100% exactly as you sent - no deletion) ===
  All lines below are your original second copy of the functions.
  Commented only to fix syntax error (duplicate const names).
  */
  const formatTime = (minutes) => {
    const hours = Math.floor(minutes / 60);
    const mins = minutes % 60;
  ...
  /* === DUPLICATE BLOCK END (your original lines fully kept) === */
